package com.manu.weatherforecast.integrations;
...
public class WeatherForecastIntegrationTest {
	...
	@Test
	public void getWeatherForecastResponse() {
		...
		List<WeatherMatrix> WeatherMatrices = this.weatherForecastService
				.getWeatherForecastResponse("cyberjaya");
		WeatherMatrix WeatherMatrix = WeatherMatrices.get(0);
		assertThat(WeatherMatrix.getAvg_day_temp()).isEqualTo(82.8775);
		assertThat(WeatherMatrix.getAvg_night_temp()).isEqualTo(78.54249999999999);
		assertThat(WeatherMatrix.getAvg_pressure()).isEqualTo(1020.005);
