package com.manu.weatherforecast.models;
...
public class WeatherMatrix {
	...
	public WeatherMatrix(LocalDate date, double avg_day_temp, double avg_night_temp, double avg_pressure) {
		super();
		this.date = date;
